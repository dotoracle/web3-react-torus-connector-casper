...
var TorusConnector = /*#__PURE__*/function (_AbstractConnector) {
  ...
  _proto.activate = function activate() {
    try {
      ...
      var _temp4 = function () {
        if (!_this3.torus) {
          return Promise.resolve(new Promise(function (resolve) { resolve(_interopNamespace(require('@toruslabs/casper-embed'))); }).then(function (m) {
            var _m$default;
...
//# sourceMappingURL=dotoracle-web3-react-torus-connector.cjs.development.js.map
