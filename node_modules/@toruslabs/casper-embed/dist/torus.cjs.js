...
var http_helpers_ = __webpack_require__(5);
...
var external_is_stream_ = __webpack_require__(6);
...
var external_loglevel_ = __webpack_require__(7);
var external_loglevel_default = /*#__PURE__*/__webpack_require__.n(external_loglevel_);

// CONCATENATED MODULE: ./src/loglevel.ts

/* harmony default export */ var loglevel = (external_loglevel_default.a.getLogger("casper-embed"));
...
var external_fast_deep_equal_ = __webpack_require__(8);
  ...
  _handleAccountsChanged(accounts) {
    ...
    if (!external_fast_deep_equal_default()(this._state.accounts, finalAccounts)) {
      ...
      if (isEthAccounts && Array.isArray(this._state.accounts) && this._state.accounts.length > 0 && !isInternal) {
        loglevel.error('Torus: "casper_accounts" unexpectedly updated accounts. Please report this bug.', finalAccounts);
      }
